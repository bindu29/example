...
def transformation(data):
    ...
    return transformed_data, obj_t_list,  trans_rem_col, trans_col
...
def dt_transformation_inv(data, obj,trans_col,name):
    ...
    if name in trans_col:
        ...
        #print('Inverse transformation Completed')
        #print('length of inverse transformed data is :' + str(len(num_data)))
...
def correlations(data, columnsArray, no_rem_col, Val):
    ...
    data, rm_cols = remove_col(data, ratio=25, no_rem_col=no_rem_col)
    print(rm_cols)
    ...
    if (num_data.shape[1]>0):
        ...
        data1, obj_t, col,trans_col = transformation(temp_dat)
...
#    data = pd.concat(frames, axis=1)
    ...
    return ent_cor,data,rm_cols, miss_cols, obj_t, sub,drop_columns,trans_col
